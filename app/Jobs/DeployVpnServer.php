...
public function handle(): void
{
    ...
    try {
        ...
        Log::info('SSH test command output:', $testOutput);
        Log::info('SSH test command exit code:', [$testStatus]);
        if ($testStatus !== 0 || !in_array('CONNECTION_OK', $testOutput)) {
        ...
        Log::info('Full deployment SSH command:', [$fullCmd]);
