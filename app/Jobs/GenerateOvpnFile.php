...
class GenerateOvpnFile implements ShouldQueue
{
    ...
    {
        Log::info("🔧 Generating OVPN file(s) for user: {$this->vpnUser->username}");
        ...
        Log::info("✅ Completed OVPN file generation for user: {$this->vpnUser->username}");
    }
    ...
    {
        Log::info("🔧 Generating OVPN file for server: {$server->name} ({$server->ip_address})");
