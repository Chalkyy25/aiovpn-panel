        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:space-x-8">
                ...
                <div @mouseenter="usersOpen = true" @mouseleave="usersOpen = false" class="relative">
                    ...
                    <div x-show="usersOpen" class="absolute mt-2 bg-white shadow rounded py-1 w-48 z-10">
                ...
                <div @mouseenter="linesOpen = true" @mouseleave="linesOpen = false" class="relative">
                    ...
                    <div x-show="linesOpen" class="absolute mt-2 bg-white shadow rounded py-1 w-48 z-10">
                        <x-nav-link href="{{ route('admin.vpn-users.create') }}">Add Line</x-nav-link>
                        <x-nav-link href="#">Generate Trial Line</x-nav-link> {{-- Add actual route when ready --}}
