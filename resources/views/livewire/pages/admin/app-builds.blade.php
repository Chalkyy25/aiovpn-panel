...
<div class="space-y-6">
  ...
  <div class="pill-card outline-cya p-5 space-y-4">
    ...
    {{-- IMPORTANT: do NOT call wire:submit="upload" --}}
    <form wire:submit.prevent="saveBuild" class="space-y-4">
      ...
      <div class="space-y-2">
        ...
        <button
          ...
          wire:target="apk,saveBuild"
        >
          Upload Build
        </button>

        <div class="aio-help" wire:loading wire:target="apk,saveBuild">
