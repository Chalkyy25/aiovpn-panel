                ...
                @forelse ($users as $user)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                            <button wire:click="generateOvpn({{ $user->id }})" class="text-indigo-600 hover:text-indigo-900">
                                OpenVPN
                            </button>
                            <button wire:click="generateWireGuard({{ $user->id }})" class="text-blue-600 hover:text-blue-900">
                                WireGuard
                            </button>
