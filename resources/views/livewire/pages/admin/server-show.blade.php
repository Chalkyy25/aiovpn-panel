        ...
        <div x-show="confirmRedeploy" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <div class="bg-white p-6 rounded shadow">
                ...
                <div class="flex gap-2">
                    <button @click="$wire.deployServer(); confirmRedeploy = false" class="bg-blue-600 text-white px-4 py-2 rounded">Yes</button>
                    <button @click="confirmRedeploy = false" class="bg-gray-300 px-4 py-2 rounded">Cancel</button>
                </div>
            </div>
        </div>
